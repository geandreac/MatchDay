...
+             "id": "color-contrast",
+             "impact": "serious",
+             "message": "Element has insufficient color contrast of 2.52 (foreground color: #475264, background color: #08080e, font size: 10.5pt (14px), font weight: normal). Expected contrast ratio of 4.5:1",
+             "relatedNodes": Array [
+               Object {
+                 "html": "<body>",
+                 "target": Array [
...
+   Element has insufficient color contrast of 2.52 (foreground color: #475264, background color: #08080e, font size: 10.5pt (14px), font weight: normal). Expected contrast ratio of 4.5:1",
...
+             "id": "color-contrast",
+             "impact": "serious",
+             "message": "Element has insufficient color contrast of 2.43 (foreground color: #475264, background color: #0e0e15, font size: 9.0pt (12px), font weight: normal). Expected contrast ratio of 4.5:1",
+             "relatedNodes": Array [
+               Object {
...
+         ],
+         "failureSummary": "Fix any of the following:
+   Element has insufficient color contrast of 2.43 (foreground color: #475264, background color: #0e0e15, font size: 9.0pt (12px), font weight: normal). Expected contrast ratio of 4.5:1",
...
+             "id": "color-contrast",
+             "impact": "serious",
+             "message": "Element has insufficient color contrast of 4.47 (foreground color: #1a8945, background color: #08080e, font size: 10.5pt (14px), font weight: normal). Expected contrast ratio of 4.5:1",
+             "relatedNodes": Array [
+               Object {
+                 "html": "<body>",
+                 "target": Array [
...
+         ],
+         "failureSummary": "Fix any of the following:
+   Element has insufficient color contrast of 4.47 (foreground color: #1a8945, background color: #08080e, font size: 10.5pt (14px), font weight: normal). Expected contrast ratio of 4.5:1",
+         "html": "<a class=\"font-semibold text-primary hover:text-primary-dark transition-colors\" href=\"/login\">Entrar</a>",
+         "impact": "serious",
+         "none": Array [],
+         "target": Array [
+           ".font-semibold",
