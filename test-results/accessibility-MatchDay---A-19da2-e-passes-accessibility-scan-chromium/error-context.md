...
+             "id": "color-contrast",
+             "impact": "serious",
+             "message": "Element has insufficient color contrast of 2.68 (foreground color: #4a5668, background color: #08080e, font size: 10.5pt (14px), font weight: normal). Expected contrast ratio of 4.5:1",
+             "relatedNodes": Array [
+               Object {
+                 "html": "<body>",
+                 "target": Array [
...
+   Element has insufficient color contrast of 2.68 (foreground color: #4a5668, background color: #08080e, font size: 10.5pt (14px), font weight: normal). Expected contrast ratio of 4.5:1",
