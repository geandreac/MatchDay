...
- Name: critical-flows.spec.ts >> MatchDay - Fluxos Criticos >> pagina offline renderiza
- Location: e2e\critical-flows.spec.ts:67:7
...
Locator: locator('h2')
Expected substring: "Voce esta offline"
Timeout: 5000ms
...
- link "Pular para conteúdo principal":
  - /url: "#main-content"
- img
- heading "Sem Conexão" [level=1]
- paragraph: Você está offline. Conecte-se à internet e tente novamente.
